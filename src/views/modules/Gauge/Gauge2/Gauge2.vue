    ...
    series: [
      {
        ...
        pointer: {
          ...
          itemStyle: {
            color: chartConfig.value.pointer.color || 'auto'
          }
        },
        axisTick: {
          length: chartConfig.value.axisTick.length,
          lineStyle: {
            color: chartConfig.value.axisTick.color || 'auto',
        ...
        splitLine: {
          ...
          lineStyle: {
            color: chartConfig.value.splitLine.color || 'auto',
            width: chartConfig.value.splitLine.width
          }
        },
        axisLabel: {
          show: chartConfig.value.axisLabel.show,
          color: chartConfig.value.axisLabel.color || 'auto',
