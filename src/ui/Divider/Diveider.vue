<template>
  <div v-if="!vertical" class="flex flex-nowrap w-full flex-row justify-center items-center">
    <div
      :class="[
  ...
  <div
    v-else
    class="bg-black dark:bg-white border-0 inline-block align-middle h-4 mr-1 ml-1"
    style="width: 1px"
  ></div>
</template>
