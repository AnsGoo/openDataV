...
const component: ComponentInfo = {
  ...
  propValue: {
    ...
    sendValue: 0,
    fontClass: 'icon iconfont icon-bofang5',
    fontColor: 'yellow',
    fontSize: 60
  },
  style: {
    ...
    children: [
      {
        ...
        type: 'imgSelect',
        selectOptions: [
          { value: 'icon iconfont icon-clock', label: 'icon iconfont icon-clock' },
          { value: 'icon iconfont icon-fankuixinxi', label: 'icon iconfont icon-fankuixinxi' },
          {
            value: 'icon iconfont icon-leijianzhuxiulix',
            label: 'icon iconfont icon-leijianzhuxiulix'
          },
          { value: 'icon iconfont icon-weibiaoti-', label: 'icon iconfont icon-weibiaoti-' },
          {
            value: 'icon iconfont icon-sds_di37leijianzhuxiuli',
            label: 'icon iconfont icon-sds_di37leijianzhuxiuli'
          },
          {
            value: 'icon iconfont icon-liandongkongzhi',
            label: 'icon iconfont icon-liandongkongzhi'
          },
          { value: 'icon iconfont icon-unlock-full', label: 'icon iconfont icon-unlock-full' },
          { value: 'icon iconfont icon-kaiguan', label: 'icon iconfont icon-kaiguan' },
