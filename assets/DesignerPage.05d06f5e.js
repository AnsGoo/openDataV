...
`,[U(">",[y("input",[U("&:not(:last-child)",`
 ...
 `)])]),y("collapse-item","margin-left: 32px;"),U("&:first-child","margin-top: 0;"),U("&:first-child >",[O("header","padding-top: 0;")]),Y("left-arrow-placement",[O("header",[y("collapse-item-arrow","margin-right: 4px;")])]),Y("right-arrow-placement",[O("header",[y("collapse-item-arrow","margin-left: 4px;")])]),O("content-wrapper",[O("content-inner","padding-top: 16px;"),Za({duration:"0.15s"})]),Y("active",[O("header",[Y("active",[y("collapse-item-arrow","transform: rotate(90deg);")])])]),U("&:not(:first-child)","border-top: 1px solid var(--n-divider-color);"),O("header",`
...
`,[O("dot-wrapper",`
 ...
 `),Y("checked",{boxShadow:"var(--n-box-shadow-active)"},[U("&::before",`
 opacity: 1;
 transform: scale(1);
 `)])]),O("label",`
 color: var(--n-text-color);
...
`,[O("splitor",`
 ...
 `),bt("checked",{color:"var(--n-button-text-color-hover)"})]),Y("focus",[U("&:not(:active)",[O("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),Y("checked",`
...
`,[Y("segment-type",[y("tabs-rail",[U("&.transition-disabled","color: red;",[y("tabs-tab",`
 ...
 position: relative;
 overflow: hidden;
 `,[Y("shadow-before",[U("&::before",`
 box-shadow: inset 10px 0 8px -8px rgba(0, 0, 0, .12);
 `)]),Y("shadow-after",[U("&::after",`
 box-shadow: inset -10px 0 8px -8px rgba(0, 0, 0, .12);
 `)]),U("&::before, &::after",`
 transition: box-shadow .3s var(--n-bezier);
 pointer-events: none;
