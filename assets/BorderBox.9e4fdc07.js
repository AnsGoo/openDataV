import{u as b}from"./useProp.afe31ed3.js";import{d as m,r as u,h as $,w as g,o as c,c as d,b as t,u as a,p as y,j as k,f as x,_ as w}from"./index.fa9c529b.js";const p=s=>(y("data-v-fcf2ce5b"),s=s(),k(),s),B={class:"dv-border-box-9"},C=["width","height"],I=["id"],N=p(()=>t("animate",{attributeName:"x1",values:"0%;100%;0%",dur:"10s",begin:"0s",repeatCount:"indefinite"},null,-1)),R=p(()=>t("animate",{attributeName:"x2",values:"100%;0%;100%",dur:"10s",begin:"0s",repeatCount:"indefinite"},null,-1)),L=["stop-color"],z=["values"],S=["stop-color"],D=["values"],V=["id"],j=["points"],E=["points"],G=["points"],H=["points"],P=["points"],q=["points"],A=["points"],F=["points"],J=["points"],K=["fill","points"],M=["width","height","fill","mask"],O=m({__name:"BorderBox",props:{component:null},setup(s){const f=s,{propValue:o}=b(f.component),e=u(150),l=u(150),i=u(`border-box-9-gradient-${$()}`),v=u(`border-box-9-mask-${$()}`),_=r=>{const n=r[0].contentRect;e.value=n.width,l.value=n.height};return(r,h)=>{const n=x("resize");return g((c(),d("div",B,[(c(),d("svg",{class:"dv-border-svg-container",width:e.value,height:l.value},[t("defs",null,[t("linearGradient",{id:i.value,x1:"0%",y1:"0%",x2:"100%",y2:"100%"},[N,R,t("stop",{offset:"0%","stop-color":a(o).base.colorLeft},[t("animate",{attributeName:"stop-color",values:`${a(o).base.colorLeft};${a(o).base.colorRight};${a(o).base.colorLeft}`,dur:"10s",begin:"0s",repeatCount:"indefinite"},null,8,z)],8,L),t("stop",{offset:"100%","stop-color":a(o).base.colorRight},[t("animate",{attributeName:"stop-color",values:`${a(o).base.colorRight};${a(o).base.colorLeft};${a(o).base.colorRight}`,dur:"10s",begin:"0s",repeatCount:"indefinite"},null,8,D)],8,S)],8,I),t("mask",{id:v.value},[t("polyline",{stroke:"#fff","stroke-width":"3",fill:"transparent",points:`8, ${l.value*.4} 8, 3, ${e.value*.4+7}, 3`},null,8,j),t("polyline",{fill:"#fff",points:`8, ${l.value*.15} 8, 3, ${e.value*.1+7}, 3
